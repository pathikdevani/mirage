...
// === appended: workspace create + empty states ===

// ─────────────────────────────────────────────────────────────────────────────
// LoginWorkspaceCreate — clicked "Create new workspace" from picker
// ─────────────────────────────────────────────────────────────────────────────
function LoginWorkspaceCreate() {
  const workspaces = [
    { id: 'presight-prod', name: 'presight production', color: 'cyan', initials: 'PP', env: 'production' },
    { id: 'presight-dev', name: 'presight workspace', color: 'violet', initials: 'PD', env: 'dev' },
    { id: 'g42-research', name: 'G42 research labs', color: 'emerald', initials: 'GR', env: 'staging' },
  ];
  const swatches = ['violet', 'cyan', 'emerald', 'amber', 'rose', 'slate'];
  ...
  return (
    <div className="mlogin mlogin-workspace">
      ...
      <div className="wpanel">
        ...
        <div className="wpanel-body wpanel-body-create">
          <div className="wpanel-l">
            ...
            <div className="wpanel-l-mini">
              <div className="step-no">3 workspaces</div>
              <h3>You'll still see these</h3>
              <div className="ws-list mini">
                {workspaces.map(w => (
                  <div key={w.id} className="ws-row mini">
                    <div className={`ws-avatar ${w.color}`}>{w.initials}</div>
                    <div className="ws-info">
                      <div className="ws-name-row">
                        <span className="nm">{w.name}</span>
              ...
              <div className="qa-card">
                <div className="qa-head">
                  ...
                  <b>What's a workspace?</b>
                </div>
                <p>A workspace holds your schemas, generated sets, connectors, and team members. Use separate workspaces to isolate dev, staging, and production data.</p>
                <a href="#" className="link strong">Read the docs →</a>
              </div>
            </div>
          </div>
          ...
          <div className="wpanel-r">
            <div className="create-card">
              <div className="create-head">
                <span className="step-no">Step 3 of 3 · New workspace</span>
                <h2>Create a workspace</h2>
                <p className="lede">Set up a new isolated space for schemas, sets, and team members. You can change most of these later.</p>
              </div>

              <form className="create-form" onSubmit={(e) => e.preventDefault()}>
                <div className="cf-row cf-row-name">
                  <div className={`ws-avatar violet lg create-avatar`}>
                    PW
                    <button type="button" className="avatar-edit" aria-label="Change color">
                  ...
                  <div className="field full">
                    ...
                    <input className="input" defaultValue="presight workspace 2" autoFocus />
                    <span className="helper">Shown across Mirage. People will see this in the workspace switcher.</span>
                  </div>
                </div>
                ...
                <div className="field">
                  ...
                  <div className="color-swatch-row">
                    {swatches.map((c, i) => (
                      <button key={c} type="button" className={`color-swatch ${c} ${i === 0 ? 'selected' : ''}`} aria-label={c} />
                    ))}
                  </div>
                </div>
                ...
                <div className="field">
                  ...
                  <div className="url-group">
                    <span className="url-prefix mono">mirage.presight.ae /</span>
                    <input className="input" defaultValue="pw2" />
                  </div>
                  <span className="helper mono">→ mirage.presight.ae/pw2 · lowercase, hyphens only</span>
                </div>

                <div className="field">
                  <label>Environment</label>
                  <div className="env-radio-row">
                    {[
                      { id: 'production', label: 'Production', sub: 'real data flows · audit logged', danger: true },
                      { id: 'staging', label: 'Staging', sub: 'pre-prod testing' },
                      { id: 'dev', label: 'Development', sub: 'fast & loose · default', current: true },
                    ].map(e => (
                      <label key={e.id} className={`env-radio env-${e.id} ${e.current ? 'checked' : ''}`}>
                        <span className="radio-dot" />
                        <div>
                          <div className="er-label">
                            {e.label}
                            {e.danger && <span className="er-danger">⚠ irreversible writes</span>}
                          </div>
                ...
                <div className="cf-grid-2">
                  ...
                  <div className="field">
                    <label>Plan</label>
                    <div className="select-fake">
                      <span>Inherits from organization</span>
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
                    </div>
                  </div>
                </div>
                ...
                <div className="field">
                  <label>Starter template <span className="opt">(optional)</span></label>
                  <div className="template-grid">
                    {[
                      { id: 'blank', name: 'Blank', sub: 'Start empty', icon: 'M3 3h18v18H3z', selected: true },
                      { id: 'identity', name: 'Identity', sub: 'person, mobile, licence', icon: 'M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2 M12 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z' },
                      { id: 'commerce', name: 'Commerce', sub: 'customer, order, item', icon: 'M9 22V12h6v10 M3 9l9-7 9 7v13a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z' },
                      { id: 'import', name: 'Import', sub: 'from JSON / SQL', icon: 'M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4 M17 8l-5-5-5 5 M12 3v12' },
                    ].map(t => (
                      <button key={t.id} type="button" className={`tmpl-card ${t.selected ? 'selected' : ''}`}>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                          <path d={t.icon}/>
                        </svg>
                        <div className="tc-name">{t.name}</div>
                        <div className="tc-sub">{t.sub}</div>
                        {t.selected && <span className="tc-check">
...
// ─────────────────────────────────────────────────────────────────────────────
// LoginWorkspaceEmpty — user has zero workspaces
// ─────────────────────────────────────────────────────────────────────────────
function LoginWorkspaceEmpty() {
  return (
    <div className="mlogin mlogin-workspace">
      <div className="wbg" />
      <div className="wpanel">
        <div className="wpanel-head">
          <div className="mark-row">
            ...
            <div className="mark-words">
              <div className="wm">Mirage</div>
              <div className="wm-sub mono">v2.4.1 · first sign-in</div>
            </div>
          </div>
          <div className="account-chip">
            <div className="avatar-sm">PD</div>
            ...
            <button className="link muted">Sign out</button>
          </div>
        </div>

        <div className="wpanel-body wpanel-body-empty">
          <div className="empty-stage">
            <div className="empty-art">
              <svg width="140" height="100" viewBox="0 0 140 100" fill="none" aria-hidden="true">
                ...
                {/* dashed empty workspace card frame */}
                <rect x="20" y="20" width="100" height="60" rx="10" fill="none" stroke="hsl(240 5% 80%)" strokeWidth="1.5" strokeDasharray="4 4"/>
                {/* three placeholder avatars / squares inside */}
                ...
                {/* sparkle */}
                <path d="M120 30 L122 26 L124 30 L128 32 L124 34 L122 38 L120 34 L116 32 Z" fill="url(#empty-grad)"/>
              </svg>
            </div>

            <h2>You're not in a workspace yet</h2>
            <p className="empty-lede">
              A workspace is where your schemas, generated sets, and team live. Create your first one — it takes about 30 seconds — or join an existing workspace your team invited you to.
            </p>

            <div className="empty-actions">
              <button className="empty-cta primary" type="button">
                <div className="empty-cta-icon violet">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
                </div>
                <div className="empty-cta-body">
                  <div className="ec-title">Create a workspace</div>
                  <div className="ec-sub">For your team or just for you. Free up to 5 schemas.</div>
                </div>
                <span className="ec-arrow">→</span>
              </button>

              <button className="empty-cta" type="button">
                <div className="empty-cta-icon cyan">
                ...
                <div className="empty-cta-body">
                  <div className="ec-title">Join with invite code</div>
                  <div className="ec-sub">Got an 8-character code from a teammate? Paste it.</div>
                </div>
                <span className="ec-arrow">→</span>
              </button>
            </div>

            <div className="empty-helpers">
              <div className="helper-card">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>
                <div>
                  <b>Expected to see a workspace?</b>
                  <span>If your admin invited you, the invite may still be pending. <a href="#" className="link strong">Check your inbox</a> or <a href="#" className="link strong">ping your admin</a>.</span>
                </div>
              </div>
              <div className="helper-row">
                <a href="#" className="link muted">Talk to sales</a>
                <span className="sep">·</span>
                <a href="#" className="link muted">Restore archived workspace</a>
                <span className="sep">·</span>
                <a href="#" className="link muted">Sign out</a>
              </div>
            </div>
          </div>
        </div>
...
Object.assign(window, { LoginWorkspaceCreate, LoginWorkspaceEmpty });
